...
import com.toy.api.springboot.config.auth.dto.OAuthAttributes;
import com.toy.api.springboot.config.auth.dto.SessionUser;
import com.toy.api.springboot.domain.user.User;
import com.toy.api.springboot.domain.user.UserRepository;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        //이렇게 Dto 클래스를 만들지 않고 바로 User 클래스를 사용하면 직렬화가 구현되지 않았다는 에러 발생
